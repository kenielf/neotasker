...
\addto\extrasportuguese{\renewcommand{\contentsname}{\centering{SUMÁRIO}}{\vspace{1cm}}}
...
\begin{itemize}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.75]{UnitTest/trueCase/stats.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.75]{UnitTest/falseCase/stats.png}
...
podem ser encontradas no site oficial da Oracle, no link \url{https://www.oracle.com/java/technologies/downloads/}.
...
\raggedright
\noindent ABOUT APACHE NETBEANS. Disponível em: <\url{https://netbeans.apache.org/about/index.html}>. Acesso em: 24 nov. 2023. \linebreak
...
\noindent Apache Maven Assembly Plugin – Introduction. Disponível em: <\url{https://maven.apache.org/plugins/maven-assembly-plugin/index.html}>. 
Acesso em: 26 nov. 2023. \linebreak

\noindent ARNOLD, K. et al. THE JavaTM Programming Language, Fourth Edition. [s.l: s.n.]. 
Disponível em: <\url{https://www.acs.ase.ro/Media/Default/documents/java/ClaudiuVinte/books/ArnoldGoslingHolmes06.pdf}>. 
Acesso em: 24 nov. 2023. \linebreak

\noindent CLARO, D.; BOSCO, J.; SOBRAL, M. Programação em JAVA. [s.l: s.n.]. 
Disponível em: <\url{http://www.lasid.ufba.br/teste/pessoal/danielaclaro/download/Programando\\%20em\\%20Java.pdf}>. 
...
\noindent Documentation - TeX Live - TeX Users Group. Disponível em: <\url{https://tug.org/texlive/doc.html}>. Acesso em: 27 nov. 2023. \linebreak

\noindent Download the Latest Java LTS Free. Disponível em: <\url{https://www.oracle.com/br/java/technologies/downloads/}>. 
Acesso em: 23 nov. 2023. \linebreak

\noindent ELMASRI, Ramez et al. Sistemas de banco de dados. 2005. Acesso em: 23 set. 2022. \linebreak

\noindent FlatLaf - Flat Look and Feel | FormDev. Disponível em: <\url{https://www.formdev.com/flatlaf/}>. Acesso em: 26 nov. 2023. \linebreak

\noindent Git - Documentation. Disponível em: <\url{https://git-scm.com/doc}>. ‌Acesso em: 26 nov. 2023. \linebreak

\noindent GIT. Git - About Version Control. Disponível em: <\url{https://git-scm.com/book/en/v2/Getting-Started-About-Version-Control}>.
‌Acesso em: 26 nov. 2023. \linebreak
...
Disponível em: <\url{https://blog.betrybe.com/git/\#2}>. Acesso em: 26 nov. 2023.

\noindent Gson. Disponível em: <\url{https://google.github.io/gson/}>. Acesso em: 26 nov. 2023. \linebreak

\noindent Home - Neovim. Disponível em: <\url{https://neovim.io/}>. Acesso em: 24 nov. 2023. \linebreak

\noindent JAVA, L.; SOARES INDRUSIAK, L. Grupo JavaRS JUG Rio Grande do Sul. [s.l: s.n.]. 
Disponível em: <\url{https://www.cin.ufpe.br/~arfs/introjava.pdf}>. Acesso em: 23 nov. 2023. \linebreak

\noindent Jsoup: Java HTML parser, built for HTML editing, cleaning, scraping, and XSS safety. Disponível em: <\url{https://jsoup.org}>.
Acesso em: 26 nov. 2023. \linebreak
...
Disponível em: <\url{https://www.studocu.com/pt-br/document/instituto-federal-de-educacao-ciencia-e-tecnologia-sao-paulo/banco-de-dados/ch03-rm-resumo-anotacoes-bando-de-dados/15426577}> 
Acesso em: 23 nov. 2023. \linebreak

\noindent DE, F. Mariela Inés Cortés Fortaleza 2013. [s.l: s.n.]. 
Disponível em: <\url{https://www.uece.br/cct/wp-content/uploads/sites/28/2021/07/Fundamentos-de-Engenharia-de-Software.pdf}>. 
Acesso em: 26 nov. 2023. \linebreak

\noindent Medium. Disponível em: <\url{https://brasil.uxdesign.cc/as-cores-na-experi}>. Acesso em: 24 nov. 2023. \linebreak

\noindent MiG Layout Java Layout Manager for Swing and SWT. Disponível em: <\url{https://www.miglayout.com}>. Acesso em: 26 nov. 2023. \linebreak

\noindent MIJACOBS. O que é o Git? - Azure DevOps. Disponível em: <\url{https://learn.microsoft.com/pt-br/devops/develop/git/what-is-git}>. Acesso em: 24 nov. 2023. \linebreak

\noindent NetBeans IDE | Oracle Brasil. Disponível em: <\url{https://www.oracle.com/br/tools/technologies/netbeans-ide.html}>. Acesso em: 24 nov. 2023 \linebreak
...
Disponível em: <\url{https://www.alura.com.br/artigos/psicologia-das-cores-veja-como-isso-e-essencial-para-o-sucesso-do-designer}>.
Acesso em: 24 nov. 2023. \linebreak 

\noindent Sobre o Git - Documentação do GitHub. Disponível em: <\url{https://docs.github.com/pt/get-started/using-git/about-git}>. Acesso em: 24 nov. 2023. \linebreak

\noindent TIOBE. TIOBE Index | TIOBE - The Software Quality Company. Disponível em: <\url{https://www.tiobe.com/tiobe-index/}>. Acesso em: 24 nov. 2023. \linebreak

\noindent Vim. Disponível em: <\url{https://pt.wikipedia.org/wiki/Vim}>. Acesso em: 24 nov. 2023. \linebreak

\noindent VISUAL STUDIO CODE. Documentation for Visual Studio Code. Disponível em: <\url{https://code.visualstudio.com/docs}>. Acesso em: 24 nov. 2023. \linebreak

\noindent Your relational data. Objectively. - Hibernate ORM. Disponível em: <\url{https://hibernate.org/orm/}>. Acesso em: 26 nov. 2023. \linebreak

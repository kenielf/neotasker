...
\pagebreak
\begin{itemize}
\item\textbf{RF06 - Obter Informações do Sistema Operacional:}
\end{itemize}
...
\pagebreak
\begin{itemize}
\item\textbf{RF07 - Mostrar Dados de Estatísticas:}
\end{itemize}
...
\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_dark/1.png}
	\caption{JFrame Principal - Modo Dark}
\end{picture}

\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_dark/2.png}
	\caption{JPanel Calendário - Modo Dark}
\end{picture}

\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_dark/3.png}
	\caption{JPanel de Informações e Estatísticas - Modo Dark}
\end{picture}

\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_dark/4.png}
	\caption{JPanel de Configurações - Modo Dark}
\end{picture}

\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_dark/5.png}
	\caption{JPanel de Adição de Tasks - Modo Dark}
\end{picture}

\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_white/7.png}
	\caption{JFrame Principal - Modo White}
\end{picture}

\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_white/8.png}
	\caption{JPanel Calendário - Modo White}
\end{picture}

\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_white/9.png}
	\caption{JPanel de Informações e Estatísticas - Modo White}
\end{picture}

\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_white/10.png}
	\caption{JPanel de Configurações - Modo White}
\end{picture}

\begin{picture}
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_white/11.png}
	\caption{JPanel de Adição de Tasks - Modo White}
\end{picture}
\pagebreak

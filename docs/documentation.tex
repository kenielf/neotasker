...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_dark/lista.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_dark/criar.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.19]{prototypes/oficial_white/add.png}

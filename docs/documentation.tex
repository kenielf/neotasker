...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.50]{requirements/functionals/requirements.png}
	\caption{Requisitos Funcionais do Sistema}
\end{figure}
Descrição de cada Requisito Funcional:
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.50]{requirements/functionals/description.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.50]{requirements/not-functionals/not-functionals.png}
	\caption{Requisitos Não-Funcionais do Sistema}
\end{figure}
Descrição de cada Requisito Não-Funcional:
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.50]{requirements/not-functionals/description.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.50]{requirements/domain/domain.png}
	\caption{Requisitos de Domínio do Sistema}
\end{figure}
Descrição de cada Requisito de Domínio:
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.50]{requirements/domain/description.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.40]{DFDs/RF01.drawio.png}
	\caption{DFD do RF01}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.40]{DFDs/RF02.drawio.png}
	\caption{DFD do RF04}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.40]{DFDs/RF03.drawio.png}
	\caption{DFD do RF03}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.40]{DFDs/RF05.drawio.png}
	\caption{DFD do RF05}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.40]{DFDs/RF06.drawio.png}
	\caption{DFD do RF06}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.40]{DFDs/RF07.drawio.png}
	\caption{DFD do RF07}
\end{figure}

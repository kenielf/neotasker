...
Abaixo, segue uma lista de compnentes possíveis com o AWT:
\begin{itemize}
	\item \textbf{Janela:} Representa uma janela na tela, onde os componentes são adicionados;
	\item \textbf{Painel:} Representa um contêiner que agrupa um conjunto de componentes;
	\item \textbf{Rótulo:} Representa um componente que exibe um texto não editável;
	\item \textbf{Botão:} Representa um componente que, quando clicado, executa uma ação;
	\item \textbf{Campo de Texto:} Representa um componente que permite a entrada de texto;
	\item \textbf{Área de Texto:} Representa um componente que permite a entrada de texto em múltiplas linhas;
	\item \textbf{Caixa de Seleção:} Representa um componente que permite a seleção de uma ou mais opções;
	\item \textbf{Caixa de Listagem:} Representa um componente que permite a seleção de uma ou mais opções em uma lista;
	\item \textbf{Barra de Rolagem:} Representa um componente que permite a rolagem de uma lista de itens;
	\item \textbf{Barra de Menu:} Representa um componente que permite a criação de menus;
	\item \textbf{Barra de Ferramentas:} Representa um componente que permite a criação de barras de ferramentas;
	\item \textbf{Caixa de Diálogo:} Representa um componente que permite a criação de caixas de diálogo;
	\item \textbf{Imagem:} Representa um componente que permite a exibição de imagens;
	\item \textbf{Tabela:} Representa um componente que permite a exibição de dados em forma de tabela;
	\item \textbf{Área de Desenho:} Representa um componente que permite a exibição de gráficos;
	\item \textbf{Controle Deslizante:} Representa um componente que permite a seleção de um valor em uma faixa de valores;
	\item \textbf{Rótulo de Texto:} Representa um componente que exibe um texto não editável com ícone;
\end{itemize}


O AWT é antecessor a uma bilioteca para interfaces gráficas conhecida como Swing
\subsubsection{EXPLICAR COMO APLICOU}
